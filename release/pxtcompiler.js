...
(function (pxt) {
    var SimpleHost = /** @class */ (function () {
        ...
        SimpleHost.prototype.readFile = function (module, filename) {
            var fid = module.id == "this" ? filename :
                ...
                function checkCall(n, env, asExpression, topLevel) {
                    ...
                    function checkArgument(arg) {
                        ...
                        function checkEnumArgument(enumArg) {
                            ...
                            var parts = paramInfo.type.split(".");
                            var enumParts = [];
            ...
            function isLiteralNode(node) {
                ...
                switch (node.kind) {
                    ...
                    case SK.ArrayLiteralExpression:
                        ...
                        for (var _i = 0, _a = arr.elements; _i < _a.length; _i++) {
                            var el = _a[_i];
...
(function (ts) {
    ...
    (function (pxtc) {
        ...
        function compileBinary(program, opts, res, entryPoint) {
            ...
            var resDiags = diagnostics.getDiagnostics();
            reset();
            needsUsingInfo = false;
            bin.finalPass = true;
            emit(rootFunction);
...
(function (ts) {
    ...
    (function (pxtc) {
        ...
        function runConversionsAndStoreResults(opts, res) {
            ...
            var postIdx = opts.sourceFiles.indexOf("_onCodeStop.ts");
            if (postIdx >= 0) {
        ...
        function getTSProgram(opts, old) {
            ...
            // run post-processing code last, if present
            var post_idx = tsFiles.indexOf("_onCodeStop.ts");
            if (post_idx >= 0) {
