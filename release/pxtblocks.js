...
(function (pxt) {
    ...
    (function (blocks_4) {
        ...
        (function (layout) {
            ...
            function screenshotAsync(ws, pixelDensity) {
                return toPngAsync(ws, pixelDensity);
            }
            layout.screenshotAsync = screenshotAsync;
            function toPngAsync(ws, pixelDensity) {
...
(function (pxtblockly) {
    ...
    var ICON_WIDTH = 30;
    var TOTAL_HEIGHT = PADDING * 2 + BG_PADDING * 2 + PREVIEW_WIDTH;
    var TOTAL_WIDTH = TOTAL_HEIGHT + ICON_WIDTH;
    var FieldAnimationEditor = /** @class */ (function (_super) {
        ...
        function FieldAnimationEditor(text, params, validator) {
            ...
            _this.onMouseEnter = function () {
                if (_this.animateRef)
                    return;
                var interval = _this.interval > 50 ? _this.interval : 50;
                var index = 0;
        ...
        FieldAnimationEditor.prototype.showEditor_ = function () {
            ...
            var fv = pxt.react.getFieldEditorView("animation-editor", this.getValue() + this.getParentInterval(), this.params);
            ...
            fv.onHide(function () {
                ...
                if (result) {
                    ...
                    var frameString = result.substring(0, result.lastIndexOf("]") + 1);
                    var intervalString = result.substring(frameString.length);
                    _this.state = parseImageArrayString(frameString);
                    var newInterval = Number(intervalString);
                    if (!isNaN(newInterval)) {
                        _this.interval = newInterval;
                        _this.setParentInterval(_this.interval);
                    }
                    _this.redrawPreview();
        ...
        FieldAnimationEditor.prototype.getValue = function () {
            if (!this.state)
                return "[]";
            return "[" + this.state.map(function (frame) {
                return pxt.sprite.bitmapToImageLiteral(frame, "typescript" /* TypeScript */);
            }).join(",") + "]";
        };
        ...
        FieldAnimationEditor.prototype.redrawPreview = function () {
            ...
            if (this.state) {
                this.frames = this.state.map(function (frame) { return pxtblockly.bitmapToImageURI(frame, PREVIEW_WIDTH, _this.lightMode); });
    ...
    function parseImageArrayString(str) {
        str = str.replace(/[\[\]]/mg, "");
        return str.split(",").map(function (s) { return pxt.sprite.imageLiteralToBitmap(s); });
    }
...
(function (pxtblockly) {
    var FieldPosition = /** @class */ (function (_super) {
        ...
        FieldPosition.prototype.setValue = function (value) {
...
(function (pxtblockly) {
    ...
    var FieldSpriteEditor = /** @class */ (function (_super) {
        ...
        FieldSpriteEditor.prototype.showEditor_ = function () {
            var _this = this;
            this.params.blocksInfo = this.blocksInfo;
            var fv = pxt.react.getFieldEditorView("image-editor", this.getValue(), this.params);
            if (this.undoRedoState) {
                fv.restorePersistentData(this.undoRedoState);
            }
            fv.onHide(function () {
                ...
                if (result) {
                    var old = _this.getValue();
                    _this.state = pxt.sprite.imageLiteralToBitmap(result);
                    _this.redrawPreview();
                    _this.undoRedoState = fv.getPersistentData();
                    if (_this.sourceBlock_ && Blockly.Events.isEnabled()) {
                        Blockly.Events.fire(new Blockly.Events.BlockChange(_this.sourceBlock_, 'field', _this.name, old, _this.getValue()));
